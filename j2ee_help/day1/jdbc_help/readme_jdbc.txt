...
1. JAR supplied by DB vendor or Driver vendor --- consists of JDBC driver -- ie. a converter for Java Data <-----> Native DB types 
...
For DAC lab PC  -- jdbc:oracle:thin:@localhost:1521:xe
