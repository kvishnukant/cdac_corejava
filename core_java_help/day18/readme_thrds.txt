...
Regarding User Threads Vs Daemon Threads
Default -- User Threads -- DO NOT automatically expire along with their parent thread. -- can cause orphan scenario

Daemon threads -- not created as a default.
How To?
Thread class API ---
public void setDaemon(boolean flag)
flag=true
Daemon thrds --- DO  automatically expire along with their parent thread. -- can't  cause orphan scenario
