...
2. Swing components(JFC comps) are inherently thrd un-safe.
While adding JComponents ---to the Container -- add them in thread safe manner.

In the absence of thrd safety ---
main & EDT --- can concurrently access SAME copy JComponents.

Reco -- Ensure that ONLY EDT --- is responsible for all possible handling (create/attach event listener/ add them to container) of JComps. 

How To ?
API 
javax.swing.SwingUtilities
public static void invokeLater(Runnable inst)
--- Causes inst's run() to be invoked by EDT 
...
Supports --- ActionEvent,ItemEvent
...
Regarding Box layout
1. javax.swing.Box --- light weight container to support Box layout---can create horizontal & vertical boxes.(similiar to JPanel)
2 How to create hori. box
Box hBox1 = Box.createHorizontalBox();
3. How to vertical box
public static Box createVerticalBox();
4.How to create fixed hori space in between comps?
public static Component createHorizontalStrut(int width)
5. How to create fixed vertical space in between comps?
public static Component createVerticalStrut(int height)
Creates an invisible, fixed-height component. 
6. How to fix component width or height ?
Can be done by adding a glue component.
...
JPasswordField ---similar construcotrs as JtextField
...
5. public List<E> getSelectedValuesList() --- rets list of selected items
6. public E getSelectedValue()
