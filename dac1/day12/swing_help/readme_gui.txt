...
Yes --- EDT invokes event handling logic(mouseClicked,keyPressed....) --- upon returning --- code continues.

Golden prog rules swing programming
1. Never delay or block EDT --- by writing longer event handling logic or painting logic. If required create ur own thrds & DO NOT burden system thrds.
