...
public class CustomerMapSort2 {
	...
	public static void main(String[] args) {
		try {
			...
			/*
			 * Sort custs as per their subscription amt
			 */
			Collection<Customer> coll = custs.values();
			Vector<Customer> v1=new Vector<>(coll);
			Collections.sort(v1, new Comparator<Customer>() {
				...
				public int compare(Customer arg0, Customer arg1) {
					...
					return (int) (arg0.getSubscriptionAmt() - arg1
							.getSubscriptionAmt());
				}
